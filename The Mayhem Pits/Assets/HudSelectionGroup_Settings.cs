...
public class HudSelectionGroup_Settings : HUDSelectionGroup {
    ...
    {
        if (children[index].GetComponent<HUDAxisSlider>())
        {
            children[index].GetComponent<HUDAxisSlider>().Slide(direction);
        }
    }
}
